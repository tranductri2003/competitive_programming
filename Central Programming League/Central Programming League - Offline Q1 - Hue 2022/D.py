...
class SegmentTree:
    def __init__(self,mang,n,X,Y):
        self.a=mang
        self.N=n
        self.INF_MIN=-10**9
        self.INF_MAX=10**9
        def buildTree(mang,l,r,X,Y):
            ...
            root.left=buildTree(mang,l,mid,X,Y)
            root.right=buildTree(mang,mid+1,r,X,Y)
            ...
            if root.max==X and root.min==Y:
                root.count+=1
            
            
            return root
        self.root=buildTree(mang,0,n-1,X,Y)
