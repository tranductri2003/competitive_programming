...
while len(queue)!=0 and stop==False:   #BFS đến khi không còn phần tử nào trong queue
    u=queue[0]          
    queue.pop(0)
...
print(f"Con đường ngắn nhất từ nơi nhà thám hiểm đang đứng (ô {E}) đến biên (ô {F}) là: ",end="")
while F!=E:
    print(F,end=" <- ")
    F=trace[F]
print(E)
