#https://bkdnoj.dut.udn.vn/public/practice_problem.php?id=FC102_PRIME
...
# https://bkdnoj.dut.udn.vn/public/practice_problem.php?id=Demo6B
...
if x1==x2:
    ...
    if tua%maua==0:
        ...
        uocchunglonnhat=math.gcd(tua,maua)
        tua=tua//uocchunglonnhat
        maua=maua//uocchunglonnhat   
    ...
    if tub%maub==0:
        ...
        uocchunglonnhat=math.gcd(tub,maub)
        tub=tub//uocchunglonnhat
        maub=maub//uocchunglonnhat

    distance=lcm(abs(maua),abs(maub))
