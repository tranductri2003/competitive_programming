...
for test in range(testcase):
    ...
    if  check_quadrilateral(x1,y1,x2,y2,x3,y3,x4,y4)==False:
        ...
        check=[False]*5
        if x1==min(x1,x2,x3,x4):
            check[1]=True
        if x2==min(x1,x2,x3,x4):
            check[2]=True
        if x3==min(x1,x2,x3,x4):
            check[3]=True
        ...
        if x1==max(x1,x2,x3,x4):
            check[1]=True
        if x2==max(x1,x2,x3,x4):
            check[2]=True
        if x3==max(x1,x2,x3,x4):
            check[3]=True
        ...
        if y1==max(y1,y2,y3,y4):
            check[1]=True
        if y2==max(y1,y2,y3,y4):
            check[2]=True
        if y3==max(y1,y2,y3,y4):
            check[3]=True
        if y4==max(y1,y2,y3,y4):
            check[4]=True
            
            
        if y1==min(y1,y2,y3,y4):
            check[1]=True
        if y2==min(y1,y2,y3,y4):
            check[2]=True
        if y3==min(y1,y2,y3,y4):
            check[3]=True
        if y4==min(y1,y2,y3,y4):
            check[4]=True
