...
def check(x1,y1,x2,y2,x3,y3,x4,y4):
        check=0
        if linear_equation(x1,x2,y1,y2)==True: #=x
            if (x3>x1 and x4>x1) or (x3<x1 and x4<x1):
                check+=1
        elif linear_equation(x1,x2,y1,y2)==False: #=y
        ...
        if linear_equation(x2,x3,y2,y3)==True: #=x
            if (x4>x2 and x1>x2) or (x4<x2 and x1<x2):
                check+=1
        elif linear_equation(x2,x3,y2,y3)==False: #=y
        ...
        if linear_equation(x3,x4,y3,y4)==True: #=x
            if (x1>x3 and x2>x3) or (x1<x3 and x2<x3):
                check+=1
        elif linear_equation(x3,x4,y3,y4)==False: #=y
        ...
        if linear_equation(x4,x1,y4,y1)==True: #=x
            if (x2>x1 and x3>x1) or (x2<x1 and x3<x1):
                check+=1
        elif linear_equation(x4,x1,y4,y1)==False: #=y
...
for test in range(testcase):
    x1,y1,x2,y2,x3,y3,x4,y4=get_ints()
    if  check_quadrilateral(x1,y1,x2,y2,x3,y3,x4,y4)==False:
        print("NO")
    else:
        res=False
        if check(x1,y1,x2,y2,x3,y3,x4,y4)==True:
            res=True
        elif check(x1,y1,x2,y2,x4,y4,x3,y3)==True:
            res=True
        elif check(x1,y1,x3,y3,x2,y2,x4,y4)==True:
            res=True
        elif check(x1,y1,x3,y3,x4,y4,x2,y2)==True:
            res=True
        elif check(x1,y1,x4,y4,x2,y2,x3,y3)==True:
            res=True
        elif check(x1,y1,x4,y4,x3,y3,x2,y2)==True:
            res=True
        else:
            res=False
        if res==True:
