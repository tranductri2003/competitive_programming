...
nhungtudaxoa=[]
for cum in range(1,n):
    stringmoi=[]
    for vitribatdau in range(0,n-cum):
        tuhientai=string[vitribatdau:vitribatdau+cum]
        tutieptheo=string[vitribatdau+cum:vitribatdau+cum+cum]
        if tuhientai==tutieptheo:
            nhungtudaxoa.append(tuhientai)
            for i in range(vitribatdau,vitribatdau+cum):
                string[i]=""
            vitribatdau+=cum
res=0
...
for chu in string:
    chu=str(chu)
    stringmoi=stringmoi+chu


nhungtudaxoamoi=[]
for tu in nhungtudaxoa:
    tumoi=""
    for chu in tu:
        tumoi=tumoi+chu
    nhungtudaxoamoi.append(tumoi)

print(stringmoi)
nhungtudaxoamoi=list(set(nhungtudaxoamoi))
print(nhungtudaxoamoi)
for tu in nhungtudaxoamoi:
    if tu in stringmoi and len(tu)>1:
        res-=1
for i in string:
    if i!="":
        res+=1
