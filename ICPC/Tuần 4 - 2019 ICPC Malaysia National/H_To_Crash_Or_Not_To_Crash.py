...
if "=" in string1:
    indexx=string1.index("=")
    for i in range(indexx+1,len(string1)):
        if string1[i]!=".":
            print(string1[i])
            quit()
        
if "=" in string2:
    indexx=string2.index("=")
    for i in range(indexx+1,len(string2)):
        if string2[i]!=".":
            print(string2[i])
            quit()

if "=" in string3:
    indexx=string3.index("=")
    for i in range(indexx+1,len(string3)):
        if string3[i]!=".":
            print(string3[i])
            quit()
