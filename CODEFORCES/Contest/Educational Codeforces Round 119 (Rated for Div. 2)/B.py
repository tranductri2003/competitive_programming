...
for test in range(testcase):
    ...
    canhtren=list(map(int,input().split()))[1:]
    res=max(res,(max(canhtren)-min(canhtren))*h)
    canhduoi=list(map(int,input().split()))[1:]
    res=max(res,(max(canhduoi)-min(canhduoi))*h)
    canhtrai=list(map(int,input().split()))[1:]
    res=max(res,(max(canhtrai)-min(canhtrai))*w)
    canhphai=list(map(int,input().split()))[1:]
    res=max(res,(max(canhphai)-min(canhphai))*w)
    print(res)
