...
for test in range(testcase):
    ...
    vitrihondalon=a.index(hondalon)
    vitrihondanho=a.index(hondanho)
    
    solon=max(vitrihondalon,vitrihondanho)+1
    sonho=min(vitrihondalon,vitrihondanho)+1
    
    res=min(solon,n-sonho+1,sonho+n-solon+1)
    print(res)