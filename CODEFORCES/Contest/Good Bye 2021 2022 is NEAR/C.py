...
for test in range(testcase):
    ...
    if n==1:
        print(0)
            ...
            res=10**9
            khoangcachgiuacacso=0
            for soxuatphat in range(0,n-1):
                for soketthuc in range(soxuatphat+1,n):
                    khoangcachgiuacacso=(a[soketthuc]-a[soxuatphat])/(soketthuc-soxuatphat)
                    temp1=0
                    temp2=0
                    for sothu in range(0,n):
                        giatriexpected=a[soxuatphat]+khoangcachgiuacacso*(sothu-soxuatphat)
                        if a[sothu]!=giatriexpected:
                            temp1+=1                            
