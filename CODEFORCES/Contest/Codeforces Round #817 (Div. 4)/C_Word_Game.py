...
for _ in range(t):
    n = int(input())
    check1 = defaultdict(lambda: -1)
    check2 = defaultdict(lambda: -1)
    check3 = defaultdict(lambda: -1)
    ...
    res3 = 0
    for word in s1:
        if check2[word] == -1 and check3[word] == -1:
            res1 += 3
        elif check2[word] == 1 and check3[word] == 1:
            res1 += 0
        else:
            res1 += 1
    for word in s2:
        if check1[word] == -1 and check3[word] == -1:
            res2 += 3
        elif check1[word] == 1 and check3[word] == 1:
            res2 += 0
        else:
            res2 += 1
    for word in s3:
        if check1[word] == -1 and check2[word] == -1:
            res3 += 3
        elif check1[word] == 1 and check2[word] == 1:
            res3 += 0
        else:
            res3 += 1
