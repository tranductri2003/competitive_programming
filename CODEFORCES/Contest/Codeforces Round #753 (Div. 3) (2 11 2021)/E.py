...
for test in range(testcase):
    ...
    row,collumn=get_ints()

    initialrow=row
    initialcollumn=collumn
    ...
    row=list(range(0,row+1))
    collumn=list(range(0,collumn+1))
    ...
    for i in range(0,len(a)):
        if a[i]=="L":
            vertical-=1
            if vertical<0:
                if collumn[-vertical]!=0:
                    collumn[-vertical]=0
                    ncollumn-=1
            elif vertical>0:
                if collumn[initialcollumn+1-vertical]!=0:
                    collumn[initialcollumn+1-vertical]=0
                    ncollumn-=1
        elif a[i]=="R":
            vertical+=1
            if vertical<0:
            ...
            if horizontal<0:
                ...
                if row[initialrow+1-horizontal]!=0:
                    row[initialrow+1-horizontal]=0
                    nrow-=1
        else:
            horizontal+=1        
            if horizontal<0:
        ...
        if nrow==0:
            if horizontal<0:
                ...
                resrow=initialrow+1-horizontal
            stoprow=True
            break
        if ncollumn==0:
            if vertical<0:
                ...
                rescollumn=initialcollumn+1-vertical
            stopcollumn=True
            break


    if stoprow==True and stopcollumn==True:
