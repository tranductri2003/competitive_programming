...
#     for j in range(26):
#         if data[j]!=[]:
#             duoi=upper_bound(data[j],l-1)
#             tren=lower_bound(data[j],r-1)
#             # print(f"duoi: {duoi}, tren: {tren}")
#             res+=(tren-duoi+1)*j
#     print(res)
...
for i in range(1,n+1):
    prefixSum[i]=prefixSum[i-1]+ord(string[i-1])-96
for i in range(q):
    l,r=get_ints()
