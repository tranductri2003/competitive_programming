...
# for i in range(2,max(n,k)+1):
#     for j in range(2,max(n,k)+1):
...
#!      Filename: B_Mashmokh_and_ACM.py
#*      Folder: D:\Code\Python\Codeforces\ProblemSet
#?      Author: TranDucTri2003
#TODO   CreatedAt: 2022-05-06 09:27:11



#Cho tới n. Tìm số tập hợp gồm k số sao cho các số nhỏ hơn bằng n và số sau chia hết cho số trước đó
n,k=list(map(int,input().split()))
...
#*      Folder: D:\Code\Python\Codeforces\ProblemSet
#?      Author: TranDucTri2003
#TODO   CreatedAt: 2022-05-06 11:08:56
