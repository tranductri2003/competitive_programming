...
for _ in range(t):
    n,k=get_ints()
    a=get_ints()   #Mình có và cần phân phối
    w=get_ints()   #Mỗi người bạn cần chính xác chừng này số nguyên
    
    #Hạnh phúc của mỗi người bạn là tổng của số nguyên lớn nhất và số nguyên nhỏ nhất của số đó
